...
def api_vversion_reports_revenue_by_customer_post(version, body=None):  # noqa: E501
    ...
    if check["test_key"] == "ok":
        if connexion.request.is_json:
            body = FiscalYear.from_dict(connexion.request.get_json())  # noqa: E501
...
def api_vversion_reports_revenue_by_month_post(version, body=None):  # noqa: E501
